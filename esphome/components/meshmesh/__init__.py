...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_BIND_SERVER, default=False): cv.boolean,
    }
...
async def to_code(config):
    ...
    if CONF_BIND_SERVER in config and config[CONF_BIND_SERVER] is True:
        cg.add_define("USE_BIND_SERVER")
